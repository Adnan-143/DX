...
#Script Editeimport Majharul Islam Tutul
...
\033[1;92mAuthor \033[1;93m: Toxic Tutul

\033[1;92mFb \033[1;93m: Majharul Islam Tutul
...
def main():
    ...
    print ' \033[0m[3].\x1b[1;96m New Fb Group  '
...
def log_sel():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://facebook.com/groups/unique.force.officia.group/')
